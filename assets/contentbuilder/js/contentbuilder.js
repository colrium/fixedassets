...
(function(jQuery) {
    ...
    jQuery.contentbuilder = function(element, options) {
        ...
        this.init = function() {
            ...
            var toolbarholder = this.settings.toolbarholder;
            ...
            if (jQuery('#divCb').length == 0) {
                jQuery(toolbarholder).append('<div id="divCb"></div>');
            }
            if (jQuery('#divSnippets').length == 0) {
                ...
                html_catselect = '<select id="selSnips" style="display:none;cursor:pointer;">' + html_catselect + '</select>';
                var s = '<div id="divTool">' + html_catselect;
                s += '<div id="divSnippetList"></div>';
                s += '';
                s += '<br><div class="range-field" id="divRange"><input type="range" id="inpZoom" min="80" max="100" value="100"></div>';
                s += '';
                s += '<a id="lnkToolOpen" href="#"><i class="material-icons" style="font-size: 15px;">chevron_left</i></a></div>';
            ...
            $element.children("*").append('<div class="row-tool">' + 
                                                '<div class="row-handle"><i class="material-icons spaced-text">open_with</i></div>' + 
                                                '<div class="row-html"><i class="material-icons spaced-text">code</i></div>' + 
                                                '<div class="row-copy"><i class="material-icons spaced-text">content_copy</i></div>' + 
                                                '<div class="row-remove"><i class="material-icons spaced-text">clear</i></div>' + 
                                        '</div>');
            ...
            if (this.settings.snippetTool == 'right') {
                ...
                jQuery("#lnkToolOpen").click(function(e) {
                    ...
                    if (parseInt(jQuery('#divTool').css('right')) == 0) {
                        ...
                        jQuery("#lnkToolOpen i").html('chevron_left')
                    } else {
                        jQuery('#divTool').animate({
                            right: '+=' + toolwidth + 'px'
                        }, 200);
                        jQuery("#lnkToolOpen i").html('chevron_right')
                    }
                    e.preventDefault()
                });
            ...
            jQuery(document).bind('mousedown', function(event) {
                ...
                if (jQuery(event.target).parents('.ui-draggable').length > 0 && jQuery(event.target).parents(cb_list).length > 0) {
                    ...
                    if (is_firefox)
                        jQuery(event.target).parents(".ui-draggable").addClass('firefox');
        ...
        this.applyBehavior = function() {
            ...
            $element.find(selectable).focus(function() {
                ...
                if (is_firefox)
                    jQuery(this).parents(".ui-draggable").addClass('firefox');
                jQuery('.row-tool').stop(true, true).fadeOut(0);
    ...
    jQuery.contenteditor = function(element, options) {
        ...
        this.init = function() {
            ...
            var html_rte = '<div id="rte-toolbar"' + toolbar_attr + '>' + 
                                '<a href="#" class="waves-effect waves-dark" data-rte-cmd="bold"> <i class="material-icons spaced-text">format_bold</i> </a>' + 
                                '<a href="#" class="waves-effect waves-dark" data-rte-cmd="italic"> <i class="material-icons spaced-text">format_italic</i> </a>' + 
                                '<a href="#" class="waves-effect waves-dark" data-rte-cmd="underline"> <i class="material-icons spaced-text">format_underlined</i> </a>' + 
                                '<a href="#" class="waves-effect waves-dark" data-rte-cmd="strikethrough"> <i class="material-icons spaced-text">strikethrough_s</i> </a>' + 
                                '<a href="#" class="waves-effect waves-dark blue-text" data-rte-cmd="color"> <i class="material-icons spaced-text">format_color_text</i> </a>' + 
                                '<a href="#" class="waves-effect waves-dark" data-rte-cmd="fontsize"> <i class="material-icons spaced-text">format_size</i> </a>' + 
                                '<a href="#" class="waves-effect waves-dark" data-rte-cmd="removeFormat"> <i class="material-icons spaced-text">format_clear</i> </a>' + 
                                '<a href="#" class="waves-effect waves-dark" data-rte-cmd="formatPara"> <i class="material-icons spaced-text">title</i> </a>' + 
                                '<a href="#" class="waves-effect waves-dark" data-rte-cmd="font"> <i class="material-icons spaced-text">text_fields</i> </a>' + 
                                '<a href="#" class="waves-effect waves-dark" data-rte-cmd="align"> <i class="material-icons spaced-text">format_align_left</i> </a>' + 
                                '<a href="#" class="waves-effect waves-dark" data-rte-cmd="list"> <i class="material-icons spaced-text">format_list_bulleted</i> </a>' + 
                                '<a href="#" class="waves-effect waves-dark" data-rte-cmd="createLink"> <i class="material-icons spaced-text">link</i> </a>' + 
                                '<a href="#" class="waves-effect waves-dark grey-text" data-rte-cmd="unlink"> <i class="material-icons spaced-text">link</i> </a>' + 
                                '<a href="#" class="waves-effect waves-dark" data-rte-cmd="html"> <i class="material-icons spaced-text">code</i> </a>' +

                            '</div>' + 
                            '<div id="divRteLink">' + 
                                '<i class="material-icons spaced-text">link</i> Edit Link' + 
                            '</div>' + 
                            '<div id="divFrameLink">' + 
                                '<i class="material-icons spaced-text">link</i> Edit Link' + 
                            '</div>' + 
                            ...
                            '<div class="md-modal" id="md-createsrc">' + 
                                ...
                                '</div>' + 
                            '</div>' + 
                            '<div class="md-modal" id="md-align" style="background:#fff; padding:15px;">' + 
                                '<div class="md-content">' + 
                                    '<div class="md-body">' + 
                                        '<button class="md-pickalign btn-flat waves-effect waves-dark" data-align="left"> <i class="material-icons spaced-text">format_align_left</i> <span>Left</span> </button>' + 
                                        '<button class="md-pickalign btn-flat waves-effect waves-dark" data-align="center"> <i class="material-icons spaced-text">format_align_center</i> <span>Center</span> </button>' + 
                                        '<button class="md-pickalign btn-flat waves-effect waves-dark" data-align="right"> <i class="material-icons spaced-text">format_align_right</i> <span>Right</span> </button>' + 
                                        '<button class="md-pickalign btn-flat waves-effect waves-dark" data-align="justify"> <i class="material-icons spaced-text">format_align_justify</i> <span>Full</span> </button>' + 
                                    '</div>' + 
                                '</div>' + 
                            '</div>' + 
                            '<div class="md-modal" id="md-list" style="background:#fff;padding:15px;">' + 
                                '<div class="md-content">' + 
                                    '<div class="md-body">' + 
                                        '<button class="md-picklist btn-flat waves-effect waves-dark" data-list="indent"> <i class="material-icons spaced-text">format_indent_increase</i> <span>Indent</span> </button>' + 
                                        '<button class="md-picklist btn-flat waves-effect waves-dark" data-list="outdent"> <i class="material-icons spaced-text flipped">format_indent_increase</i> <span>Outdent</span></button>' + 
                                        '<button class="md-picklist btn-flat waves-effect waves-dark" data-list="insertUnorderedList"> <i class="material-icons spaced-text">format_list_bulleted</i> <span>Bullet</span> </button>' + 
                                        '<button class="md-picklist btn-flat waves-effect waves-dark" data-list="insertOrderedList"> <i class="material-icons spaced-text">format_list_numbered</i> <span>Numbered</span> </button>' + 
                                        '<button class="md-picklist btn-flat waves-effect waves-dark" data-list="normal"> <i class="material-icons spaced-text">clear</i> <span>None</span> </button>' + 
                                    '</div>' + 
                                '</div>' + 
                            '</div>' + 
                            '<div class="md-modal" id="md-fonts" style="border-radius:12px">' + 
                                '<div class="md-content" style="border-radius:12px">' + 
                                    '<div class="md-body">' + 
                                        ...
                                        '<button class="md-pickfontfamily btn-flat waves-effect waves-dark" data-font-family="" data-provider="" style="display:none"></button>' + 
                                    '</div>' + 
                                '</div>' + 
                            '</div>' + 
                            '<div class="md-modal" id="md-fontsize">' + 
                                '<div class="md-content" style="border-radius:12px">' + 
                                    '<div class="md-body">' + 
                                        ...
                                        '<button class="md-pickfontsize btn-flat waves-effect waves-dark" data-font-size="" style="display:none"></button>' + 
                                    '</div>' + 
                                '</div>' + 
                            '</div>' + 
                            '<div class="md-modal" id="md-headings">' + 
                                '<div class="md-content" style="border-radius:12px">' + 
                                    '<div class="md-body">' + 
                                        ...
                                        '<button class="md-pickheading btn-flat waves-effect waves-dark" data-heading="" style="display:none"></button>' + 
                                    '</div>' + 
                                '</div>' + 
                            '</div>' + 
                            '<div class="md-modal" id="md-color" style="background:#fff;padding:15px;">' + 
                                '<div class="md-content">' + 
                                    '<div class="md-body">' + 
                                        '<div style="width:100%">' + 
                                            ...
                                            '<button id="btnCleanColor btn-flat waves-effect waves-dark" style="cursor: pointer;background: #FFFFFF;border: none;margin: 0 0 0 10px;vertical-align: middle;"><i class="cb-icon-eraser" style="color:#555;font-size:25px"></i></button>' + 
                                        '</div>' + 
                                        '[COLORS]' + 
                                    '</div>' + 
                                '</div>' + 
            ...
            jQuery(document).on('mousedown', function(event) {
                var bEditable = false;
                if (jQuery('#rte-toolbar').css('display') == 'none')
                    return;
        ...
        this.realtime = function() {
            ...
            if (jQuery(el).parents("[data-mode='code']").length > 0)
                return;
            if (jQuery(el).parents("[data-mode='readonly']").length > 0)
                return;
        ...
        this.render = function() {
            ...
            $element.find('a').not('.not-a').hover(function(e) {
                ...
                if (jQuery(this).parents("[data-mode='readonly']").length > 0)
                    return;
                if (jQuery(this).children('img').length == 1 && jQuery(this).children().length == 1)
                    return;
                var zoom = localStorage.zoom;
                if (zoom == 'normal')
                    zoom = 1;
...
function pasteContent($activeElement) {
    ...
    setTimeout(function() {
        try {
            ...
            if (jQuery('#idContentWord').length == 0)
                return;
            var sPastedText = '';
        ...
        this.init = function() {
            ...
            if (this.settings.imageEmbed) {
                if (navigator.appName.indexOf('Microsoft') != -1) {
                    ...
                    html_photo_file2 = '<div class="avatar-char white-text" id="divToolImg">' + '<i id="lnkEditImage" class="material-icons spaced-text">camera_alt</i>' + '</div>'
                }
            }
            ...
            html_hover_icons += '</select>';
            html_hover_icons += '<button class="btn" id="btnInsertPlh" style="margin-left:12px"> REPLACE </button>';
                ...
                if (file.type.match('image.*')) {
                    ...
                    reader.onload = (function(theFile) {
                        return function(e) {
                            ...
                            if ($imgActive.prop("tagName").toLowerCase() == 'img') {
                                jQuery("#my-mask").css('width', $imgActive.width() * enlarge + 'px');
                            ...
                            if (specifiedCssWidth != 0)
                                jQuery("#my-mask").css('width', specifiedCssWidth + 'px');
                            if (specifiedCssHeight != 0)
                                jQuery("#my-mask").css('height', specifiedCssHeight + 'px');
                            ...
                            oimg.onload = function(evt) {
                                ...
                                jQuery('#btnZoomOut').bind('click', function() {
                                    var nCurrentWidth = parseInt(jQuery("#my-image").css('width'));
                                    var nCurrentHeight = parseInt(jQuery("#my-image").css('height'));
                                    if ((nCurrentWidth / 1.1) < jQuery("#my-mask").width())
                                        return;
                                    if ((nCurrentHeight / 1.1) < jQuery("#my-mask").height())
                                        return;
...
jQuery.fn.clearFields = jQuery.fn.clearInputs = function(includeHidden) {
    ...
    return this.each(function() {
        ...
        if (re.test(t) || tag == 'textarea') {
            ...
            if ((includeHidden === true && /hidden/.test(t)) || (typeof includeHidden == 'string' && jQuery(this).is(includeHidden)))
                this.value = ''
        }
    })
}
