        ...
        return $(this).each(function() {
            ...
            var
                ...
                _td_options = $.extend({
                    ...
                    primaryColor: "#1977CC",
                    borderColor: "#1977CC",
                    selectorBackgroundColor: "#1977CC",
                    selectorBorderColor: "#1977CC",
                    backgroundColor: "#FFF",
                    selectedTimeTextColor: "#1977CC",
                    textColor: '#555'
            ...
            $('head').append('<style>#td-clock-' + _td_id + ' .td-clock {color:' + _td_options.textColor + '; background: ' + _td_options.backgroundColor + '; box-shadow: 0 0 0 1px ' + _td_options.borderColor + ',0 0 0 8px rgba('+_hexToRgb(_td_options.borderColor)+', 0.5); } #td-clock-' + _td_id + ' .td-clock .td-time span.on { color:' + _td_options.selectedTimeTextColor + '} #td-clock-' + _td_id + ' .td-clock:before { border-color: ' + _td_options.primaryColor + '} #td-clock-' + _td_id + ' .td-select:after { box-shadow: 0 0 0 1px ' + _td_options.selectorBorderColor + ' } #td-clock-' + _td_id + ' .td-clock:before {background: ' + _td_options.primaryColor + ';} #td-clock-' + _td_id + ' .td-select:after {background: ' + _td_options.selectorBackgroundColor + ';} #td-clock-' + _td_id + ' .td-lancette {border: 2px solid ' + _td_options.primaryColor + '; opacity:0.1}#td-clock-' + _td_id + ' .td-lancette div:after { background: ' + _td_options.primaryColor + ';} #td-clock-' + _td_id + ' .td-bulletpoint div:after { background:' + _td_options.primaryColor + '; opacity:0.1}</style>');
            ...
            _td_c.find('svg').attr('style', "fill:" + _td_options.selectorBackgroundColor+"; stroke:"+ _td_options.selectorBorderColor+";");
                    ...
                    if (e.originalEvent.wheelDelta > 0) {
                        if (_td_wheel_deg <= 360) {
                            if (e.originalEvent.wheelDelta <= 120) _td_wheel_deg++
                                else if (e.originalEvent.wheelDelta > 120) _td_wheel_deg = _td_wheel_deg + 30;
            ...
            _td_input.click(function(e) {
                ...
                _td_c.css({
                    'top': (_td_input.offset().top + (_td_input.outerHeight()+10)),
                    'left': (_td_input.offset().left + (_td_input.outerWidth() / 4)) - (_td_c.outerWidth() / 2)
                });
            ...
            $(window).on('resize', function() {
                ...
                _td_c.css({
                    'top': (_td_input.offset().top + (_td_input.outerHeight() + 10)),
                    'left': (_td_input.offset().left) + (_td_c.outerWidth() / 2)
                });
            });
