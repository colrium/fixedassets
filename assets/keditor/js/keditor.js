...
(function ($) {
    ...
    KEditor.DEFAULTS = {
        ...
        btnMoveContainerText: '<i class="material-icons">format_line_spacing</i>',
        btnMoveComponentText: '<i class="material-icons">open_with</i>',
        btnSettingContainerText: '<i class="material-icons">settings</i>',
        btnSettingComponentText: '<i class="material-icons">settings</i>',
        btnDuplicateContainerText: '<i class="material-icons">content_copy</i>',
        btnDuplicateComponentText: '<i class="material-icons">content_copy</i>',
        btnDeleteContainerText: '<i class="material-icons">delete</i>',
        btnDeleteComponentText: '<i class="material-icons">delete</i>',
        ...
        snippets: '<div data-type="container" data-keditor-title="1 column" data-categories="1 column">\
                        <div class="row">\
                    ...
                    \
                    <div data-type="container" data-keditor-title="2 columns (50% - 50%)" data-categories="2 columns">\
                        <div class="row">\
                            <div class="col s6" data-type="container-content">\
                            </div>\
                            <div class="col s6" data-type="container-content">\
                            </div>\
                        </div>\
                    ...
                    \
                    <div data-type="container" data-keditor-title="2 columns (33% - 67%)" data-categories="2 columns">\
                        <div class="row">\
                            <div class="col s4" data-type="container-content">\
                            </div>\
                            <div class="col s8" data-type="container-content">\
                            </div>\
                        </div>\
                    </div>\
                    \
                    <div data-type="container" data-keditor-title="2 columns (67% - 33%)" data-categories="2 columns">\
                        <div class="row">\
                            <div class="col s8" data-type="container-content">\
                            </div>\
                            <div class="col s4" data-type="container-content">\
                    ...
                    \
                    <div data-type="container" data-keditor-title="3 columns (33% - 33% - 33%)" data-categories="3 columns">\
                        <div class="row">\
                            <div class="col s4" data-type="container-content">\
                            </div>\
                            <div class="col s4" data-type="container-content">\
                    ...
                    \
                    <div data-type="container" data-keditor-title="3 columns (25% - 50% - 35%)" data-categories="3 columns">\
                        <div class="row">\
                            <div class="col s3" data-type="container-content">\
                            </div>\
                            <div class="col s6" data-type="container-content">\
                            </div>\
                            <div class="col s3" data-type="container-content">\
                    ...
                    \
                    <div data-type="container" data-keditor-title="4 columns (25% - 25% - 25% - 25%)" data-categories="4 columns">\
                        <div class="row">\
                            <div class="col s3" data-type="container-content">\
                            </div>\
                            <div class="col s3" data-type="container-content">\
                    ...
                    \
                    \
                    <div data-type="component-text" data-keditor-title="Page header" data-categories="Text;Heading;Bootstrap component">\
                    ...
                    \
                    <div data-type="component-text" data-keditor-title="Jumbotron" data-categories="Text;Heading;Bootstrap component;Dynamic component">\
                        <div class="jumbotron">\
                            <h1>Hello, world!</h1>\
                    ...
                    \
                    <div data-type="component-photo" data-keditor-title="Photo" data-categories="Media;Photo">\
                        <div class="photo-panel">\
                            <img src="snippets/default/img/somewhere_bangladesh.jpg" width="100%" height="" />\
                        </div>\
                    </div>\
                    \
                    <div data-type="component-audio" data-keditor-title="Audio" data-categories="Media">\
                        <div class="audio-wrapper">\
                            <audio src="http://www.noiseaddicts.com/samples_1w72b820/2558.mp3" controls style="width: 100%"></audio>\
                        </div>\
                    </div>\
                    \
                    <div data-type="component-video" data-keditor-title="Video" data-categories="Media">\
                    ...
                    \
                    <div data-type="component-youtube" data-keditor-title="Youtube" data-categories="Media">\
                    ...
                    \
                    <div data-type="component-vimeo" data-keditor-title="Vimeo" data-categories="Media">\
                    ...
                    \
                    <div data-type="component-googlemap" data-keditor-title="Google Map" data-categories="Gmap">\
                    ...
                    \
                    <div data-type="component-text" data-keditor-title="Thumbnail Panel" data-categories="Text;Photo;Bootstrap component">\
                        <div class="thumbnail">\
                            <img src="snippets/default/img/somewhere_bangladesh.jpg" width="100%" height="" />\
                            <div class="caption">\
                    ...
                    \
                    <div data-type="component-text" data-keditor-title="Heading 1" data-categories="Text;Heading">\
                        <h1>Heading text 1</h1>\
                        <p>Body text</p>\
                    </div>\
                    \
                    <div data-type="component-text" data-keditor-title="Heading 2" data-categories="Text;Heading">\
                        <h2>Heading text 2</h2>\
                        <p>Body text</p>\
                    </div>\
                    \
                    <div data-type="component-text" data-keditor-title="Media Panel" data-categories="Media;Photo;Bootstrap component">\
                        <div class="media">\
                    ...
                    \
                    <div data-type="component-text" data-keditor-title="Featured Article" data-categories="Text;Heading;Photo">\
                        <div class="row">\
                    ...
                    \
                    <div data-type="component-text" data-keditor-title="Articles List" data-categories="Text;Heading;Photo">\
                        <div class="row">\
                    ...
                    \
                    <div data-type="component-nonExisting" data-website="website01" data-blog="blog01" data-article="article01" data-tags="tag01,tag02" data-keditor-title="Text block with dynamic content" data-categories="Text;Dynamic component">\
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Porro labore architecto fuga tempore omnis aliquid, rerum numquam deleniti ipsam earum velit aliquam deserunt, molestiae officiis mollitia accusantium suscipit fugiat esse magnam eaque cumque, iste corrupti magni? Illo dicta saepe, maiores fugit aliquid consequuntur aut, rem ex iusto dolorem molestias obcaecati eveniet vel voluptatibus recusandae illum, voluptatem! Odit est possimus nesciunt.</p>\
                        <div data-dynamic-href="snippets/default/_dynamic_content.html"></div>\
                    </div>',
        snippetsUrl: './assets/keditor/snippets/default/snippets.html',
        gridsnippetsUrl: {''},
    ...
    KEditor.prototype = {
        ...
        initSidebar: function () {
            ...
            var snippetdoms = KEditor.DEFAULTS.snippets

            self.renderSnippets(snippetdoms);
            self.initSnippets();
            self.initTabs();
