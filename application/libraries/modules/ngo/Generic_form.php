...
class Generic_form {
   ...
   //---------------------------------------------------------------
      ...
      $strHold =
          '<tr>
              ...
              <td class="'.$this->strEntryClass.'" style="padding-bottom: 6px;'.$this->strStyleExtraValue.'">'
                 .$this->strTextBoxPrefix.'
                 <input class="form-control" type="'.($this->bPassword ? 'password' : 'text').'" name="'.$strFieldName.'" '
   ...
   function strGenericNumberEntry($strLabel, $strFieldName, $bRequired, $strValue, $lLen, $lMaxLen){
   //---------------------------------------------------------------
   //
   //---------------------------------------------------------------
      $this->setRequired($bRequired, $strClass, $strStar);
      ...
      $strHold =
          '<tr>
              ...
              <td class="'.$this->strEntryClass.'" style="padding-bottom: 6px;'.$this->strStyleExtraValue.'">'
                 .$this->strTextBoxPrefix.'
                 <input class="form-control" type="'.($this->bPassword ? 'password' : 'number').'" name="'.$strFieldName.'" '
                      .($this->bDisabled ? ' disabled="disabled" ' : '').'
                      size="'.$lLen.'"
                      maxlength="'.$lMaxLen.'" 
                      value="'.$strValue.'" style="">'.$this->strExtraFieldText.'
              </td>
           </tr>';
      $this->strExtraFieldText = $this->strTxtControlExtra = '';
      $this->bPassword = false;
      ...
      $strHold =
          '<tr>
              ...
              <td class="'.$this->strEntryClass.'" style="padding-bottom: 0px;'.$this->strStyleExtraValue.'">
                 <select class="form-control2 chosen" name="'.$strFieldName.'" '
                   .($this->bDisabled ? ' disabled="disabled" ' : '').' '
   ...
   //---------------------------------------------------------------
      ...
      $strHold =
          '<tr>
              ...
              <td class="'.$this->strEntryClass.'" style="padding-bottom: 6px;'.$this->strStyleExtraValue.'">
                 <div class="radio radio-success"><label><input type="radio"  name="'.$strFieldName.'" value="Male" '   .($enumSelect=='Male'    ? 'checked' : '').'>Male</label>  </div>
                 <div class="radio radio-success"><label><input type="radio"  name="'.$strFieldName.'" value="Female" ' .($enumSelect=='Female'  ? 'checked' : '').'>Female </label></div>
                 <div class="radio radio-success"><label><input type="radio"  name="'.$strFieldName.'" value="Unknown" '.($enumSelect=='Unknown' ? 'checked' : '').'>Unknown</label></div>'
                 .$this->strExtraFieldText.'
              </td>
           </tr>';
      $this->strExtraFieldText = '';
      ...
      $strHold =
          '<tr>
              ...
              <td class="'.$this->strEntryClass.'" style="'.$this->strStyleExtraValue.'">
                 <input  type="password" class="form-control"'.$strIDField.'
                      name="'.$strFieldName.'"
                      size="'.$lLen.'"
                      maxlength="'.$lMaxLen.'" 
                      value="'.$strValue.'">'.$this->strExtraFieldText.'
      ...
      if ($bAgainDup){
         $strHold .=
             '<tr>
                 ...
                 <td class="'.$this->strEntryClass.'" style="'.$this->strStyleExtraValue.'">
                    <input type="password" class="form-control" name="'.$strFieldName2.'"
                         size="'.$lLen.'"
                         maxlength="'.$lMaxLen.'" '
                         .$strOnFocus.'
                         value="'.$strValue2.'">
			  ...
			  <div class="checkbox">
				<label>
                 <input type="checkbox"  name="'.$strFieldName.'" '
                     .($this->bDisabled ? ' disabled="disabled" ' : '').' '
                     .$this->strSetID().'                      
                      value="'.$strCheckValue.'" '.($bChecked ? 'checked' : '').'></label></div></div> '.$this->strExtraFieldText.'
              </td>
           </tr>';
      $this->strExtraFieldText = '';
      return($strHold);
   ...
   //---------------------------------------------------------------
      ...
      $strOut =
          '<tr>
              ...
              <td class="'.$this->strEntryClass.'" align="left" style="padding-bottom: 0px;'.$this->strStyleExtraValue.'">
                 <textarea name="'.$strFieldName.'" class="form-control2"'
                     .$this->strSetID().' '
                     .$this->strTxtControlExtra.' 
                     rows="'.$lRows.'"
