...
class Curl {
	...
	function __construct(){
		...
		if (!$this->is_enabled()){
			show_error('cURL Class - PHP was not built with cURL enabled. Rebuild PHP with --with-curl to use cURL.', 500, 'CURL Disabled');
		}
	...
	public function simplecall($method='post', $url, $params = array(), $options = array()){
