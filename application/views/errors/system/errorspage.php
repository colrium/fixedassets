<script type="text/javascript" src="<?php echo CENUM_JS_DIR;?>three.min.js"></script>
<?php

$layout = '';
if($errortype == '404'){
	$layout .= '<div class="row no-select full-screen-height padded-x1 rounded-5px">
					<div class="row">
						<div class="col s12">
							<div id="world"></div>
...
elseif ($errortype == 'php') {
		$layout .= '<div class="row red full-screen-height padded-x1 rounded-5px valign-wrapper">
						<div class="col l6 offset-l3 m6 offset-m3 s12 error-text valign center-align rounded-5px padded-x2">
							<h1 class="white-text">'.maticon('bug_report', 'large').' <br> <br> '.$error_message.'</h1>
							<h3 class="white-text"> Severity: '.$error_severity.'</h2><br>
							<h5 class="white-text"> Message: '.$error_message.'</h5></br>
							<h5 class="white-text"> File: '.$error_filename.'</h5></br>
							<h5 class="white-text"> Line: '.$error_line.'</h5></br>
							<h5 class="white-text"> Backtrace: '.$error_backtrace.'</h5></br>
						</div>
					</div>';
}	
elseif ($errortype == 'mysql') {
		$layout .= '<div class="row red full-screen-height padded-x1 rounded-5px valign-wrapper">
						<div class="col l6 offset-l3 m6 offset-m3 s12 error-text valign center-align rounded-5px padded-x2">
...
elseif ($errortype == 'rec404') {
    $layout .= '<div class="row red full-screen-height rounded-5px valign-wrapper">
                  <div class="col s12 error-text valign center-align">
                  <h1 class="white-text">'.maticon('memory', 'large').' </h1>'.breaker(2).'
                  <h2 class="white-text">'.humanize($recordName).' does not exist</h2>
...
var floor, lion, fan,
    isBlowing = false;
var seconds, second, interval, cooledoff;
//SCREEN VARIABLES
