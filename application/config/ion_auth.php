...
* Version: 2.5.2
*
* Author: Collins Riungu
*		  colrium@gmail.com
*         @colrium
*
* Added Awesomeness: Fridah Mugambi
*
*
* Created:  10.01.2016
*
...
$config['tables']['priveledges']  = 'systempriveledgedefs';
$config['tables']['priveledgeallocs']  = 'systempriveledges';
/*
 ...
 */
$config['site_title']                 = "EQUUS";       // Site Title, example.com
$config['admin_email']                = "colrium@gmail.com"; // Admin Email, admin@example.com
$config['default_group']              = 'members';           // Default group, use name
$config['debug_group']                = 'debuggers';             // Default administrators group, use name
