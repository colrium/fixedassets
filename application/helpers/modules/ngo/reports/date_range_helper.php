...
//-------------------------------------------------------------------------
   ...
   $strOut .=
    '<table  cellpadding="1" cellspacing="0" class="table enRpt" style="border: 1px solid #ccc; padding:5px;">';
...
//---------------------------------------------------------------------
   ...
   return('
           <tr>
              <td valign="top">
                 <div class="radio radio-success"><label><input type="radio"
                    name="'.$strRadioFN.'" value="None" '
                  .($opts->bNoDateRange ? 'checked' : '').' ></label></div>
              </td>
              <td>
...
//---------------------------------------------------------------------
   ...
   $strOut .= '        
        <tr>
           <td valign="top">
              <div class="radio radio-success"><label><input type="radio" name="'.$strRadioFN.'" value="User" '
               .($opts->bDateRange ? 'checked':'').' ></label></div>
           </td>
           <td valign="middle">
...
//---------------------------------------------------------------------
   ...
   $strOut .= '
        <tr>
           <td valign="middle">
              <div class="radio radio-success"><label><input type="radio" name="'.$opts->strCTRL_Prefix.'rdo_TimePeriod" value="DDL" '
                    .($opts->bDatePreDefined ? 'checked' : '').'></label></div>
           </td>'."\n";
