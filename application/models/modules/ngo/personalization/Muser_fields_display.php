...
/*---------------------------------------------------------------------
 ...
 copyright (c) 2012-2013 by  Collins Riungu
...
class Muser_fields_display extends muser_fields{
   ...
   //                     break;
                     case CS_FT_TEXTLONG:
                        $strOut .= '<textarea class="form-control" name="'.$strFName.'" rows=6 cols=64 id="addEditEntry" >'
                                .htmlspecialchars($userValue).'</textarea><br>';
                        break;
                     case CS_FT_TEXT255:
                        $strOut .= '<input class="form-control" type="text" size="50" maxlength="255" name="'.$strFName.'"
                                      value="'.htmlspecialchars($userValue).'" id="addEditEntry" >&nbsp;';
                        break;
                     case CS_FT_TEXT80:
                        $strOut .= '<input type="text" class="form-control" size="50" maxlength="80" name="'.$strFName.'"
                                      value="'.htmlspecialchars($userValue).'" id="addEditEntry" >&nbsp;';
                        break;
                     case CS_FT_TEXT20:
                        $strOut .= '<input type="text"  class="form-control" size="20" maxlength="20" name="'.$strFName.'"
                                      value="'.htmlspecialchars($userValue).'" id="addEditEntry" >&nbsp;';
                        break;
                     case CS_FT_INTEGER :
                        if ($bUserEntryErr){
                        ...
                        $strOut .= '<input type="text"  class="form-control" size="10" maxlength="10" name="'.$strFName.'"
                     ...
                     case CS_FT_CURRENCY:
                        ...
                        $strOut .=
                           ...
                           .'<input type="text" class="form-control" size="10" maxlength="20" name="'.$strFName.'"
                                   value="'.$strNumber.'" id="addEditEntry" >&nbsp;'
                                   .$clsACO->countries[0]->strFlagImg;
                        break;
                     case CS_FT_DDL:
                        $strOut .= '<select class="form-control" name="'.$strFName.'" id="addEditEntry" >';
...
//                           .'The action can not be undone.\'));" ');
   ...
   //---------------------------------------------------------------------
      ...
      $strJoin .= '
         LEFT JOIN users   AS uc  ON uc.id  = '.$strFNPrefix.'_lOriginID
         LEFT JOIN users   AS ul  ON ul.id  = '.$strFNPrefix.'_lLastUpdateID '."\n";
