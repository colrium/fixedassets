...
class Muser_fields_create extends muser_fields{
   ...
   //---------------------------------------------------------------------
      ...
      switch ($this->enumTType) {
         ...
         case CENUM_CONTEXT_BIZ:
            $sqlStr =
                "INSERT INTO $strTableName ($strForeignKeyField)
                 SELECT pe_lKeyID FROM ngo_donors
         ...
         case CENUM_CONTEXT_SPONSORSHIP:
            $sqlStr =
                "INSERT INTO $strTableName ($strForeignKeyField)
                 SELECT sp_lKeyID FROM ngo_sponsor
         ...
         case CENUM_CONTEXT_CLIENT:
            $sqlStr =
                "INSERT INTO $strTableName ($strForeignKeyField)
                 SELECT cr_lKeyID FROM ngo_client_records
         ...
         case CENUM_CONTEXT_LOCATION:
            $sqlStr =
                "INSERT INTO $strTableName ($strForeignKeyField)
                 SELECT cl_lKeyID FROM ngo_client_location
         ...
         case CENUM_CONTEXT_GIFT:
            $sqlStr =
                "INSERT INTO $strTableName ($strForeignKeyField)
                 SELECT gi_lKeyID FROM ngo_gifts
         ...
         case CENUM_CONTEXT_VOLUNTEER:
            $sqlStr =
                "INSERT INTO $strTableName ($strForeignKeyField)
                 SELECT vol_lKeyID FROM ngo_volunteers
   ...
   //---------------------------------------------------------------------
         ...
         //-------------------------------------------
      $sqlStr =
         'DELETE FROM ngo_uf_fields WHERE pff_lKeyID='.$pff_lKeyID.';';
      $query = $this->db->query($sqlStr);
   ...
   //---------------------------------------------------------------------
      ...
      $sqlStr = "DELETE FROM ngo_uf_fields WHERE pff_lTableID=$lTableID;";
      $query = $this->db->query($sqlStr);

         // remove the table reference
      $sqlStr = "DELETE FROM ngo_uf_tables WHERE pft_lKeyID=$lTableID;";
      $query = $this->db->query($sqlStr);
   }
