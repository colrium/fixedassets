...
class Mrelationships extends CI_Model{
   ...
   //-----------------------------------------------------------------------
      ...
      $sqlStr =
        'SELECT
         ...
         FROM ngo_donor_relationships
            INNER JOIN ngo_lists_donor_relationships ON lpr_lKeyID=pr_lRelID_A2B
            INNER JOIN ngo_donors AS tblA       ON tblA.pe_lKeyID=pr_lPerson_A_ID
            INNER JOIN ngo_donors AS tblB       ON tblB.pe_lKeyID=pr_lPerson_B_ID
   ...
   //-----------------------------------------------------------------------
      ...
      $sqlStr =
         "DELETE FROM ngo_donor_relationships WHERE pr_lKeyID=$this->lRelID;";
      $query = $this->db->query($sqlStr);
   }
   ...
   //-----------------------------------------------------------------------
      ...
      $sqlStr =
        'INSERT INTO ngo_lists_donor_relationships
         SET
   ...
   //-----------------------------------------------------------------------
      ...
      if ($this->lRelTypeChapterID != $glChapterID){
         ...
         //---------------------------------
      $sqlStr =
         "DELETE FROM ngo_tbl_people_relationships
      ...
      $query = $this->db->query($sqlStr);
         ...
         //-------------------
      $sqlStr =
         "DELETE FROM ngo_tbl_lists_people_relationships
   ...
   //-----------------------------------------------------------------------
      ...
      $sqlStr =
        "SELECT
         ...
         FROM ngo_tbl_lists_people_relationships
         WHERE lpr_lKeyID=$this->lRelTypeID;";
   ...
   //---------------------------------------------------------------------
      ...
      $sqlStr =
         "SELECT
              ...
              lpr_strRelationship
           FROM ngo_donor_relationships
              INNER JOIN ngo_lists_donor_relationships ON pr_lRelID_A2B=lpr_lKeyID
           WHERE
              NOT pr_bRetired
   ...
   //---------------------------------------------------------------------
      ...
      $sqlStr =
          "SELECT lpr_lKeyID, lpr_strRelationship
           FROM ngo_lists_donor_relationships
   ...
   //---------------------------------------------------------------------
      ...
      if ($bNew) {
         $sqlStr =
            "INSERT INTO ngo_donor_relationships
             SET $sqlCommon,
                pr_bRetired=0,
         ...
         $sqlStr =
            "UPDATE ngo_donor_relationships
             SET $sqlCommon
   ...
   //---------------------------------------------------------------------
      $sqlStr =
         "SELECT
          ...
          FROM ngo_donor_relationships
             INNER JOIN ngo_lists_donor_relationships  ON pr_lRelID_A2B         = lpr_lKeyID
             INNER JOIN ngo_donors AS tblPeople_A ON tblPeople_A.pe_lKeyID = pr_lPerson_A_ID
             INNER JOIN ngo_donors AS tblPeople_B ON tblPeople_B.pe_lKeyID = pr_lPerson_B_ID
          WHERE pr_lKeyID=$lRelID;";
   ...
   //---------------------------------------------------------------------
      ...
      $sqlStr =
         'UPDATE ngo_lists_donor_relationships
          SET '.$this->strSQLCommonList()."
