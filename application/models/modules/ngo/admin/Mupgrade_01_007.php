...
class Mupgrade_01_007 extends mupgrade{
   ...
   //---------------------------------------------------------------------
      ...
      CREATE TABLE IF NOT EXISTS staff_ts_admin (
        ...
        tsa_lStaffID      int(11) NOT NULL DEFAULT '0' COMMENT 'Foreign key to table users',
      ...
      CREATE TABLE IF NOT EXISTS staff_ts_log (
        ...
        tsl_lStaffID      int(11)  NOT NULL DEFAULT '0' COMMENT 'Foreign key to table users',
      ...
      CREATE TABLE IF NOT EXISTS staff_ts_staff (
        ...
        tss_lStaffID      int(11) NOT NULL DEFAULT '0' COMMENT 'Foreign key to table users',
