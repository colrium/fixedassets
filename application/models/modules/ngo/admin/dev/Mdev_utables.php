   ...
   //---------------------------------------------------------------------
      ...
      $sqlStr =
        'SELECT pft_lKeyID, pft_strUserTableName, pft_strDataTableName,
         ...
         FROM ngo_uf_tables
            LEFT JOIN ngo_cprograms AS cpETable ON cpETable.cp_lEnrollmentTableID=pft_lKeyID
            LEFT JOIN ngo_cprograms AS cpATable ON cpATable.cp_lAttendanceTableID=pft_lKeyID
