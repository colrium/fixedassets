   ...
   //---------------------------------------------------------------------
      ...
      $sqlStr =
           "SELECT
            ...
            FROM ngo_creport_search
               LEFT JOIN ngo_uf_fields ON pff_lKeyID   = crs_lFieldID
...
//         case CS_FT_HLINK:
   ...
   //---------------------------------------------------------------------
      ...
      $sqlStr =
         'INSERT INTO ngo_creport_search
   ...
   //
   //---------------------------------------------------------------------
      $sqlStr = "DELETE FROM ngo_creport_search WHERE crs_lKeyID=$lTermID;";
      $this->db->query($sqlStr);
   }
   ...
   //---------------------------------------------------------------------
      $sqlStr =
           "DELETE FROM ngo_creport_search
