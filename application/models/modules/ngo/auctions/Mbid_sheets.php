   ...
   //---------------------------------------------------------------------
      ...
      $sqlStr =
        "SELECT
         ...
         FROM ngo_gifts_auctions_bidsheets
            INNER JOIN ngo_gifts_auctions ON auc_lKeyID=abs_lAuctionID
            LEFT  JOIN ngo_docs_images ON abs_lLogoImgID=di_lKeyID
            INNER JOIN users AS usersC   ON abs_lOriginID     = usersC.id
            INNER JOIN users AS usersL   ON abs_lLastUpdateID = usersL.id
   ...
   //---------------------------------------------------------------------
      ...
      return('
               <td style="vertical-align: top;">
                 <div class="radio radio-success"><label> <input  type="radio" name="'.$strRdo.'" '
                      .($lMatchID==$enumTempType ? 'checked' : '').' value="'.$enumTempType.'"></label></div>
               </td>
               <td style="vertical-align: top;">'
