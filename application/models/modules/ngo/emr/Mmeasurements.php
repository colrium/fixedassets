...
class Mmeasurements extends CI_Model{
   ...
   //---------------------------------------------------------------------
      ...
      $sqlStr =
        "SELECT
         ...
         FROM ngo_emr_measurements
            INNER JOIN users AS usersC   ON meas_lOriginID     = usersC.id
            INNER JOIN users AS usersL   ON meas_lLastUpdateID = usersL.id

            INNER JOIN ngo_client_records   ON meas_lClientID = cr_lKeyID
   ...
   //---------------------------------------------------------------------
      ...
      $sqlStr = 'INSERT INTO ngo_emr_measurements '
