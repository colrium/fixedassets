...
class Mvol_skills extends CI_Model{
   ...
   //-----------------------------------------------------------------------
      ...
      if ($bIncludeAllSkills){
         $strJoinType = " LEFT JOIN ngo_vol_skills ON ((lgen_lKeyID=vs_lSkillID) AND (vs_lVolID=$this->lVolID)) ";
      }else {
         $strJoinType = " INNER JOIN ngo_vol_skills ON ((lgen_lKeyID=vs_lSkillID) AND (vs_lVolID=$this->lVolID)) ";
      }
   ...
   //-----------------------------------------------------------------------
      ...
      $sqlStr = "DELETE FROM ngo_vol_skills WHERE vs_lVolID=$this->lVolID;";
      ...
      if ($bShowAny){
         $sqlStr =
              'SELECT DISTINCT vol_lKeyID
               FROM ngo_volunteers
                  INNER JOIN  ngo_vol_skills  ON vol_lKeyID  = vs_lVolID
   ...
   //
   //---------------------------------------------------------------------
      $this->db->query('DROP TABLE IF EXISTS ngo_tmpGroupMatch;');
