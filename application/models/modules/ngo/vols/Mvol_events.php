   ...
   //-----------------------------------------------------------------------
      ...
      $sqlStr =
        "SELECT
         ...
         FROM ngo_vol_events
            INNER JOIN users   AS uc ON uc.id=vem_lOriginID
            INNER JOIN users   AS ul ON ul.id=vem_lLastUpdateID
   ...
   //-----------------------------------------------------------------------
      ...
      $sqlStr =
        "DELETE
         ...
         FROM ngo_vol_events
            LEFT JOIN ngo_vol_events_dates               ON vem_lKeyID = ved_lVolEventID
