...
class Mclient_intake extends CI_Model{
   ...
   //---------------------------------------------------------------------
      ...
      $sqlStr = "
         ...
         FROM ngo_client_intake_forms
            INNER JOIN users   AS uc ON uc.id=cif_lOriginID
            INNER JOIN users   AS ul ON ul.id=cif_lLastUpdateID
   ...
   //---------------------------------------------------------------------
      $sqlStr =
        "SELECT citl_strLabel
         FROM ngo_client_intake_table_labels
