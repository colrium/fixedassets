      ...
      $sqlStr =
        "SELECT
         ...
         FROM $this->strAttendanceTable
            $strDDLInner
            INNER JOIN users   AS uc ON uc.id=".$this->strATableFNPrefix."_lOriginID
            INNER JOIN users   AS ul ON ul.id=".$this->strATableFNPrefix."_lLastUpdateID
   ...
   //---------------------------------------------------------------------
      ...
      $sqlStr =
        "SELECT COUNT(*) AS lNumRecs, $strFKeyFN AS lClientID,
         ...
         FROM $strATable
            INNER JOIN ngo_client_records ON $strFKeyFN=cr_lKeyID
