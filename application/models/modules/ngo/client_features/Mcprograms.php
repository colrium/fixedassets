   ...
   //---------------------------------------------------------------------
      ...
      $sqlStr =
        "SELECT
         ...
         FROM ngo_cprograms
            INNER JOIN ngo_uf_tables     AS ute ON ute.pft_lKeyID = cp_lEnrollmentTableID
            INNER JOIN ngo_uf_tables     AS uta ON uta.pft_lKeyID = cp_lAttendanceTableID
            INNER JOIN users   AS uc  ON uc.id=cp_lOriginID
            INNER JOIN users   AS ul  ON ul.id=cp_lLastUpdateID
