...
/*---------------------------------------------------------------------
// ActionAid CRM
// copyright (c) 2012  Collins Riungu
//
      ...
      $strRecurTable .=
             '<tr>
                 <td class="enpRptLabel" colspan="5">
                    <b>Total Recurrences:
                    <select name="ddlRecur" class="form-control2" style="margin:auto;">';
      ...
      $strRecurTable .=
             '<tr>
                 <td colspan="3"  nowrap>
                    ...
                    <div class="radio radio-success"><label><input type="radio" name="rdoRecur" value="daily" '.($selects->rdoRecur=='daily' ? 'checked' : '').'>
                    <b><i>Daily</span>&nbsp;</b></i></label></div>
                    <div class="radio radio-success"><label><input type="checkbox" name="chkWeekDaysOnly" value="TRUE" '.($selects->chkWeekDaysOnly ? 'checked' : '').'
                         onChange=setRadioOther('.$strForm.'.rdoRecur,\'daily\')>
                         Weekdays Only</label></div>
                 </td>
              </tr>';
      ...
      $strRecurTable .=
             '<tr>
                 <td colspan="3" >
                    ...
                    <div class="radio radio-success"><label><input type="radio" name="rdoRecur" value="weekly" '.($selects->rdoRecur=='weekly' ? 'checked' : '').' >
                    <b><i>Weekly</span></label></div>
                 </td>
              </tr>';
      ...
      $strRecurTable .=
             '<tr>
                 ...
                 <td nowrap style="border: 1px solid black;">
                    <div class="checkbox">	<label><input type="checkbox" name="chkWkSun" '.($selects->chkWkSun ? 'checked' : '').' value="TRUE" onChange=setRadioOther('.$strForm.'.rdoRecur,\'weekly\') > Sun</label></div>
                    <div class="checkbox">	<label><input type="checkbox" name="chkWkMon" '.($selects->chkWkMon ? 'checked' : '').' value="TRUE" onChange=setRadioOther('.$strForm.'.rdoRecur,\'weekly\') > Mon</label></div>
                    <div class="checkbox">	<label><input type="checkbox" name="chkWkTue" '.($selects->chkWkTue ? 'checked' : '').' value="TRUE" onChange=setRadioOther('.$strForm.'.rdoRecur,\'weekly\') > Tue</label></div>
                    <div class="checkbox">	<label><input type="checkbox" name="chkWkWed" '.($selects->chkWkWed ? 'checked' : '').' value="TRUE" onChange=setRadioOther('.$strForm.'.rdoRecur,\'weekly\') > Wed</label></div>
                    <div class="checkbox">	<label><input type="checkbox" name="chkWkThu" '.($selects->chkWkThu ? 'checked' : '').' value="TRUE" onChange=setRadioOther('.$strForm.'.rdoRecur,\'weekly\') > Thu</label></div>
                   <div class="checkbox">	<label> <input type="checkbox" name="chkWkFri" '.($selects->chkWkFri ? 'checked' : '').' value="TRUE" onChange=setRadioOther('.$strForm.'.rdoRecur,\'weekly\') > Fri</label></div>
                    <div class="checkbox">	<label><input type="checkbox" name="chkWkSat" '.($selects->chkWkSat ? 'checked' : '').' value="TRUE" onChange=setRadioOther('.$strForm.'.rdoRecur,\'weekly\') > Sat</label></div>
                 </td>
              </tr>';
      ...
      $strRecurTable .=
             '<tr>
                 <td colspan="3" >
                    ...
                    <div class="radio radio-success"><label><input type="radio" name="rdoRecur" value="monthly" '.($selects->rdoRecur=='monthly' ? 'checked' : '').'>
                    <b><i>Monthly</span></label></div>
                 </td>
              </tr>';
      ...
      $strRecurTable .=
             '<tr>
                 ...
                 <td  nowrap style="border: 1px solid black;">
                    ...
                    <div class="radio radio-success"><label><input type="radio" name="rdoFixedLoose" value="FL" '.($selects->rdoFixedLoose == 'FL' ? 'checked' : '').'>
                    Fixed monthly dates:</span></label></div> <br>
      ...
      $strRecurTable .=
             '<tr>
                 ...
                 <td nowrap style="border: 1px solid black;">
                    ...
                    <div class="radio radio-success"><label><input type="radio" name="rdoFixedLoose" value="RM" '.($selects->rdoFixedLoose == 'RM' ? 'checked' : '').'>
                    Relative monthly dates:</span></label></div> <br>
                       <table border="0" width="100%" >
                          <tr>
                             <td width="6">&nbsp;
                             <td colspan="7" align="left">
                                 <div class="checkbox">	<label><input type="checkbox" name="chkRel_1st"  value="TRUE" '.($selects->chkRel_1st  ? 'checked' : '').' onchange="setRadioOther('.$strForm.'.rdoFixedLoose,\'RM\'); setRadioOther('.$strForm.'.rdoRecur,\'monthly\')">1st</label></div>&nbsp;&nbsp;
                                 <div class="checkbox">	<label><input type="checkbox" name="chkRel_2nd"  value="TRUE" '.($selects->chkRel_2nd  ? 'checked' : '').' onchange="setRadioOther('.$strForm.'.rdoFixedLoose,\'RM\'); setRadioOther('.$strForm.'.rdoRecur,\'monthly\')">2nd</label></div>&nbsp;&nbsp;
                                 <div class="checkbox">	<label><input type="checkbox" name="chkRel_3rd"  value="TRUE" '.($selects->chkRel_3rd  ? 'checked' : '').' onchange="setRadioOther('.$strForm.'.rdoFixedLoose,\'RM\'); setRadioOther('.$strForm.'.rdoRecur,\'monthly\')">3rd</label></div>&nbsp;&nbsp;
                                 <div class="checkbox">	<label><input type="checkbox" name="chkRel_4th"  value="TRUE" '.($selects->chkRel_4th  ? 'checked' : '').' onchange="setRadioOther('.$strForm.'.rdoFixedLoose,\'RM\'); setRadioOther('.$strForm.'.rdoRecur,\'monthly\')">4th</label></div>&nbsp;&nbsp;
                                 <div class="checkbox">	<label><input type="checkbox" name="chkRel_5th"  value="TRUE" '.($selects->chkRel_5th  ? 'checked' : '').' onchange="setRadioOther('.$strForm.'.rdoFixedLoose,\'RM\'); setRadioOther('.$strForm.'.rdoRecur,\'monthly\')">5th</label></div></label></div>&nbsp;&nbsp;
                                 <div class="checkbox">	<label><input type="checkbox" name="chkRel_last" value="TRUE" '.($selects->chkRel_last ? 'checked' : '').' onchange="setRadioOther('.$strForm.'.rdoFixedLoose,\'RM\'); setRadioOther('.$strForm.'.rdoRecur,\'monthly\')">last</label></div>&nbsp;&nbsp;
                             </td>
                          </tr>

                          <tr>
                             <td width="6">&nbsp;
                             <td nowrap><div class="checkbox">	<label><input type="checkbox" value="on" name="chkRelSun" '.($selects->chkRelSun ? 'checked' : '').' onchange="setRadioOther('.$strForm.'.rdoFixedLoose,\'RM\'); setRadioOther('.$strForm.'.rdoRecur,\'monthly\')">Sun</label></div>
                             <td nowrap><div class="checkbox">	<label><input type="checkbox" value="on" name="chkRelMon" '.($selects->chkRelMon ? 'checked' : '').' onchange="setRadioOther('.$strForm.'.rdoFixedLoose,\'RM\'); setRadioOther('.$strForm.'.rdoRecur,\'monthly\')">Mon</label></div>
                             <td nowrap><div class="checkbox">	<label><input type="checkbox" value="on" name="chkRelTue" '.($selects->chkRelTue ? 'checked' : '').' onchange="setRadioOther('.$strForm.'.rdoFixedLoose,\'RM\'); setRadioOther('.$strForm.'.rdoRecur,\'monthly\')">Tue</label></div>
                             <td nowrap><div class="checkbox">	<label><input type="checkbox" value="on" name="chkRelWed" '.($selects->chkRelWed ? 'checked' : '').' onchange="setRadioOther('.$strForm.'.rdoFixedLoose,\'RM\'); setRadioOther('.$strForm.'.rdoRecur,\'monthly\')">Wed</label></div>
                             <td nowrap><div class="checkbox">	<label><input type="checkbox" value="on" name="chkRelThu" '.($selects->chkRelThu ? 'checked' : '').' onchange="setRadioOther('.$strForm.'.rdoFixedLoose,\'RM\'); setRadioOther('.$strForm.'.rdoRecur,\'monthly\')">Thu</label></div>
                             <td nowrap><div class="checkbox">	<label><input type="checkbox" value="on" name="chkRelFri" '.($selects->chkRelFri ? 'checked' : '').' onchange="setRadioOther('.$strForm.'.rdoFixedLoose,\'RM\'); setRadioOther('.$strForm.'.rdoRecur,\'monthly\')">Fri</label></div>
                             <td nowrap><div class="checkbox">	<label><input type="checkbox" value="on" name="chkRelSat" '.($selects->chkRelSat ? 'checked' : '').' onchange="setRadioOther('.$strForm.'.rdoFixedLoose,\'RM\'); setRadioOther('.$strForm.'.rdoRecur,\'monthly\')">Sat</label></div>
                          </tr>
                       </table>
                 </td>
              </tr>';
      ...
      $strRecurTable .=
             '<tr>
                 <td colspan="3" nowrap>
                    ...
                    <div class="radio radio-success"><label><input type="radio" name="rdoRecur" value="annual" '.($selects->rdoRecur=='annual' ? 'checked' : '').'>
                    <b><i>Annually</span></label></div>&nbsp;</b></i>
                 </td>
              </tr>';
