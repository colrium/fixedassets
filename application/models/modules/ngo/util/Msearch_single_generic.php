...
class Msearch_single_generic extends CI_Model{
   ...
   //-----------------------------------------------------------------------
      ...
      if ($enumSearchType==CENUM_CONTEXT_VOLUNTEER){
         ...
         if ($bNewVol){
            $strInnerVol  = ' LEFT JOIN ngo_volunteers ON pe_lKeyID=vol_lPeopleID ';
            $strWhereVol  = ' AND ((vol_lKeyID IS NULL) OR (vol_bInactive)) ';
         }else {
            $strInnerVol  = ' INNER JOIN ngo_volunteers ON pe_lKeyID=vol_lPeopleID ';
         }
      }else {
         $strInnerVol = '';
      }
          ...
          '<table class="table enpRpt" >
            ...
            .$this->strFormTag.'
              ...
              <tr>
                 ...
                 <td class="enpRpt">
                    <input class="form-control" type="text" size="5" maxlength="20" name="txtSearch" value="" id="txtSearchID">
