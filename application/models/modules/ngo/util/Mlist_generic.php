...
// ActionAid CRM!
//
// copyright (c) 2010-2015 by  Collins Riungu
// Nairobi Kenya
//
...
class Mlist_generic extends CI_Model{
   ...
   //-----------------------------------------------------------------
      ...
      $this->strListTable      = 'ngo_lists_generic';
...
//            break;
   ...
   //
   //-----------------------------------------------------------------
      $strDDL = '<select class="form-control2 chosen" name="'.$strDDLName.'">'."\n";
      if ($bAddBlank){
