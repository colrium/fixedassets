...
class Mdup_checker extends CI_Model{
   ...
   //---------------------------------------------------------------------
      ...
      $sqlStr =
        'SELECT
         ...
         FROM ngo_donors
            INNER JOIN users  AS uc ON uc.id=pe_lOriginID
            INNER JOIN users  AS ul ON ul.id=pe_lLastUpdateID
   ...
   //---------------------------------------------------------------------
      ...
      $strWarning =
          '<br><div class="formError" style="width: 400pt;">
             <b><i>ActionAid CRM</i></b> has detected '.$lNumMatches.' client'
      ...
      $strWarning .= '
            ...
            <div class="checkbox">	<label><input type="checkbox" name="'.$strCheckBoxName.'" value="true">
            I have verified that this <b>IS NOT</b> a duplicate entry</label></div><br>
            </div>
           </div>';
      return($strWarning);
   }
   ...
   //---------------------------------------------------------------------
      ...
      $strWarning =
          '<br><div class="formError" style="width: 400pt;">
             <b><i>ActionAid CRM</i></b> has detected '.$lNumMatches.' '.$strLabel1.'
