         ...
         case CENUM_CONTEXT_PEOPLE:
            $sqlStr =
               'SELECT
                ...
                FROM ngo_donors
                   LEFT JOIN ngo_lists_generic ON pe_lAttributedTo=lgen_lKeyID
         ...
         case CENUM_CONTEXT_GIFT:
            $sqlStr =
               'SELECT
                  ...
                  lgen_strListItem AS strAttribName
                FROM ngo_gifts
                   LEFT JOIN ngo_lists_generic ON gi_lAttributedTo=lgen_lKeyID
         ...
         case CENUM_CONTEXT_SPONSORSHIP:
            $sqlStr =
               'SELECT
                  ...
                  lgen_strListItem AS strAttribName
                FROM ngo_sponsor
                   LEFT JOIN ngo_lists_generic ON sp_lAttributedTo=lgen_lKeyID
