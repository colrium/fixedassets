...
class Msponsorship_programs extends CI_Model{
   ...
   //---------------------------------------------------------------------
      $sqlStr =
        "SELECT
            ...
            aco_strCurrencySymbol
         FROM ngo_lists_sponsorship_programs
            INNER JOIN ngo_client_supported_sponprogs ON sc_lKeyID=csp_lSponProgID
            INNER JOIN ngo_admin_aco                  ON sc_lACO=aco_lKeyID
         WHERE NOT sc_bRetired
   ...
   //---------------------------------------------------------------------
      ...
      $sqlStr =
         'INSERT INTO ngo_lists_sponsorship_programs
   ...
   //---------------------------------------------------------------------
      ...
      $sqlStr =
         'UPDATE ngo_lists_sponsorship_programs
          SET '.$this->strSQLCommon().',
   ...
   //---------------------------------------------------------------------
      $glUserID = USERID;
         ...
         //-------------------------------------------------------
      $sqlStr =
         "DELETE FROM ngo_client_loc_supported_sponprogs
   ...
   //---------------------------------------------------------------------
      ...
      if ($bNoSponCats && $bShowNotice){
         ...
         if ($gbAdmin){
            ...
            echoT('Please contact your '.APPNAME.' administrator to add one or more sponsorship categories.<br><br>');
         }
      }
      return($bNoSponCats);
   }
   ...
   //---------------------------------------------------------------------
      ...
      $sqlStr =
        "SELECT csp_lKeyID
         FROM ngo_client_supported_sponprogs
   ...
   //---------------------------------------------------------------------
      $sqlStr =
        "DELETE FROM ngo_client_supported_sponprogs
   ...
   //---------------------------------------------------------------------
      $sqlStr =
        "INSERT INTO ngo_client_supported_sponprogs
